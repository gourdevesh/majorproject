...
return(
    ...
    <div style={{display:'flex',justifyContent:'center'}}><button onClick={handleClose} style={{display:'flex',justifyContent:'center',marginTop:20, backgroundColor:'red',width:400,height:40,paddingTop:10,color:'white', borderRadius:11,borderColor:'#fff'}} > Close </button></div>
    </div>
...
{delivery()}
    ...
    return(
<div style={{display:'flex',flexDirection:'column',width:'100%',marginTop:25}}>             
<Paper style={{borderRadius:15,height:75}}> 
    ...
    <div style={{display:'flex',flexDirection:'column',fontSize:13,fontWeight:'bold',fontFamily:'poppins'}} >  
